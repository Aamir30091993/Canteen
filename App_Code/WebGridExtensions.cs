...
namespace GCC_Canteen.App_Code
{
    public static class WebGridExtensions
    {
            ...
            bool explicitlyCalled)
        {
            ...
            ul.Attributes.Add("style", "float:right; pading-right:10px");
            ...
            if (ModeEnabled(mode, WebGridPagerModes.Numeric) && (totalPages > 1))
            {
                ...
                for (int i = first; i <= last; i++)
                {
                    ...
                    if (i != currentPage)
                    {
                        part.MergeAttribute("class", "canClick");
                    }
        ...
        public static MvcHtmlString SortDirection(ref WebGrid grid, String columnName)
        {
            if (String.IsNullOrEmpty(columnName)) return MvcHtmlString.Empty;
